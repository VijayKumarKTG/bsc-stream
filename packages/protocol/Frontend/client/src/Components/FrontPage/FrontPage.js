...
const FrontPage = () => {
    return (
        ...
        <div className="col-md-6 offset-md-1">
            ...
            <p className="text-secondary">Bridge the gap between real-life assets and <br /> liquid assets with Pandora’s open finance protocol.</p>
          <Link to='/dashboard'>
        ...
        <div className="col-md-5 background-img">
            <img src={info} alt="" style={{height:'500px',paddingTop:'120px',}} className="img-fluid"/>
            <p></p>
        </div>
    </main>
    );
